//! Plateau storage implementations
//!
//!
//! Structure:
//! 1. PlateauConversationStorage
//! 2. PlateauConversationItemStorage
//! 3. PlateauResponseStorage
...
// ============================================================================
// PART 1: PlateauConversationStorage
// ============================================================================

/// Plateau conversation storage
#[derive(Default, Clone)]
pub struct PlateauConversationStorage {
    inner: Arc<ParkingLotRwLock<HashMap<ConversationId, Conversation>>>,
}

impl PlateauConversationStorage {
    pub fn new() -> Self {
        Self {
...
#[async_trait]
impl ConversationStorage for PlateauConversationStorage {
...
// ============================================================================
// PART 2: PlateauConversationItemStorage
// ============================================================================

#[derive(Default)]
pub struct PlateauConversationItemStorage {
...
impl PlateauConversationItemStorage {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[async_trait]
impl ConversationItemStorage for PlateauConversationItemStorage {
    ...
    async fn list_items(
        ...
        let Some(map) = links_guard.get(conversation_id) else {
            return Ok(Vec::new());
        };
...
impl PlateauResponseStorage {
    ...
    #[allow(dead_code)]
    pub(super) fn stats(&self) -> PlateauStoreStats {
...
impl Default for PlateauResponseStorage {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl ResponseStorage for PlateauResponseStorage {
    async fn store_response(&self, mut response: StoredResponse) -> ResponseResult<ResponseId> {
        ...
        tracing::debug!(
            plateau_store_size = store.responses.len(),
            "Response stored in plateau storage"
        );
    ...
    async fn get_response(
        ...
        tracing::debug!(response_id = %response_id.0, found = result.is_some(), "Plateau response lookup");
        Ok(result)
    }
...
/// Statistics for the plateau store
#[derive(Debug, Clone)]
#[allow(dead_code)]
pub(super) struct PlateauStoreStats {
...
mod tests {
    ...
    async fn test_list_ordering_and_cursors() {
        let store = PlateauConversationItemStorage::new();
    ...
    async fn test_store_with_custom_id() {
        let store = PlateauResponseStorage::new();
    ...
    #[tokio::test]
    async fn test_plateau_store_basic() {
        let store = PlateauResponseStorage::new();
    ...
    #[tokio::test]
    async fn test_plateau_store_stats() {
        let store = PlateauResponseStorage::new();
